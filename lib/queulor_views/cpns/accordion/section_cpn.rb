...
module QueulorViews::Cpns::Accordion
  class SectionCpn < QueulorViews::Base
    ...
    erb_template <<-ERB
      <%= tag.div data: { controller: "queulor-views--queulor-accordion", queulor_views__queulor_accordion_display_class: "show", queulor_views__queulor_accordion_active_class: "active" }, **html_attributes do %>
